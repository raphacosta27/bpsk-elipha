...
# Title: Top Block
# Generated: Thu Oct 26 15:20:39 2017
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._amp_slider_range = Range(0, 20, 1, 1, 150)
        self._amp_slider_win = RangeWidget(self._amp_slider_range, self.set_amp_slider, 'amp', "counter_slider", float)
        self.top_layout.addWidget(self._amp_slider_win)
        self._sps_slider_range = Range(0, 200, 10, 45, 150)
        ...
        self.qtgui_freq_sink_x_1_1 = qtgui.freq_sink_f(
        	...
        	0, #fc
        	samp_rate, #bw
        	'Frequ\xc3\xaancia modulada ', #name
        	1 #number of inputs
        )
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_c(
        	...
        	0, #fc
        	samp_rate, #bw
        	'Frequ\xc3\xaancia codificada', #name
        	1 #number of inputs
        )
        ...
        self.qtgui_const_sink_x_0_0 = qtgui.const_sink_c(
        	1024, #size
        	'Constela\xc3\xa7\xc3\xa3o antes multi', #name
        	1 #number of inputs
        )
        ...
        self.qtgui_const_sink_x_0 = qtgui.const_sink_c(
        	1024, #size
        	'Constela\xc3\xa7\xc3\xa3o depois multi', #name
        	1 #number of inputs
        )
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, fc_slider, amp_slider, 0)
        ...
        self.connect((self.blocks_complex_to_real_1, 0), (self.qtgui_freq_sink_x_1_1, 0))    
    ...
    def get_amp_slider(self):
        return self.amp_slider

    def set_amp_slider(self, amp_slider):
        self.amp_slider = amp_slider
        self.analog_sig_source_x_0.set_amplitude(self.amp_slider)
